...
import com.aben.cup.digester.SetNextRule;
import com.aben.cup.log.logging.Log;
import com.aben.cup.log.logging.LogFactory;
import com.aben.cup.sample.digester.bean.DataSources;
...
public class DigesterTest {
	...
	private DataSources getDataSources(){
        ...
        File file = null;
        try {
            file = new File("G:/workspace_github/workspace_cup/cup/cup-digester/src/test/java/com/aben/cup/sample/digester/digesterSimple.xml");;
...
//	                            "com.cup.sample.digester.bean.DataSource");
	        ...
	        digester.addRule("data-sources/data-source", new SetNextRule("addDataSource", "com.aben.cup.sample.digester.bean.DataSource"));
