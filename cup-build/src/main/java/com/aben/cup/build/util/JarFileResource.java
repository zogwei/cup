...
package com.aben.cup.build.util;
...
{
    private static final Log LOG = LogFactory.getLog(JarFileResource.class);
    ...
    public boolean exists()
    {
        ...
        if (_urlString.endsWith("!/"))
        {
            ...
            catch(Exception e) {LOG.warn(Log.IGNORED, e); return false;}
        }
