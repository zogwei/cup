...
import com.aben.cup.build.XmlParser.Node;
import com.aben.cup.build.util.ArrayQueue;
import com.aben.cup.build.util.LazyList;
import com.aben.cup.build.util.LifeCycle;
import com.aben.cup.build.util.Loader;
import com.aben.cup.build.util.Resource;
import com.aben.cup.build.util.TypeUtil;
...
public class XmlConfiguration
{
    ...
    private synchronized static XmlParser initParser()
    {
        ...
        URL config76 = Loader.getResource(XmlConfiguration.class,"com/aben/cup/build/configure_7_6.dtd");
        URL config60 = Loader.getResource(XmlConfiguration.class,"com/aben/cup/build/configure_6_0.dtd");
        URL config90 = Loader.getResource(XmlConfiguration.class,"com/aben/cup/build/configure_9_0.dtd");
...
//                   );
                    ...
                    /**
                     *	[C:\Users\wzhong\AppData\Local\Temp\start5363101026359027619.properties,
                     * 	E:\myDoc\project2\jetty-all-9.1.0.RC0\etc\jetty.xml, 
	                    E:\myDoc\project2\jetty-all-9.1.0.RC0\etc\jetty-http.xml, 
	                    E:\myDoc\project2\jetty-all-9.1.0.RC0\etc\jetty-plus.xml, 
	                    E:\myDoc\project2\jetty-all-9.1.0.RC0\etc\jetty-annotations.xml,
	                    E:\myDoc\project2\jetty-all-9.1.0.RC0\etc\jetty-deploy.xml]
                     */
